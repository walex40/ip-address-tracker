...
})({"k7mI2":[function(require,module,exports) {
...
const mapEl = document.querySelector(".map_container");
...
searchBar.addEventListener("keydown", getSearchInput); // localStorage.setItem("theme", "light");
...
},{"../images/icon-location.svg":"8ehVu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ehVu":[function(require,module,exports) {
module.exports = require("c8fe543f3b5b1a0b").getBundleURL("ea9xR") + "icon-location.f355cb28.svg" + "?" + Date.now();

},{"c8fe543f3b5b1a0b":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["k7mI2","dV6cC"], "dV6cC", "parcelRequire1541")
